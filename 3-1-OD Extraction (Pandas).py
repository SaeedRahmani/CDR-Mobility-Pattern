...
@author: Saeed Rahmani / Mahdiyar DarvishZadeh Kakhki
Part 3 - OD extraction

This code uses the stay point extracted in part 2-1 in order to estimate the Origin-Destination Matrices
